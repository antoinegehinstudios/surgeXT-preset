[Surge XT](https://github.com/surge-synthesizer/surge) presets by Antoine Géhin available on [OAS](https://github.com/open-audio-stack/open-audio-stack-registry).
